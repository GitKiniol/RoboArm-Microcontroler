...
typedef struct STEPPER_DRIVER_STRUCT
{
	...
	int16_t (*Convert)(int16_t, void*);			/* wskaŸnik do funkcji konwertuj¹cej k¹t na liczbê impulsów										*/
...
typedef struct SERVO_DRIVER_STRUCT
{
	...
	void(*Start)(void*, uint8_t);				/* wskaŸnik do funkcji uruchamiaj¹cej driver													*/
	void(*Stop)(void*);							/* wskaŸnik do funkcji zatrzymuj¹cej driver														*/
	uint16_t (*Convert)(int16_t);				/* wskaŸnik do funkcji konwertuj¹cej k¹t na wartoœæ rejestru wype³nienie impulsu PWM			*/
